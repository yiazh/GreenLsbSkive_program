...
plt.savefig(figure_file / 'Usecase2_RB' / 'res.png', dpi=150)
...
plt.savefig(figure_file / 'Usecase2_RB' / 'battery_soc.png', dpi=150)
...
plt.savefig(figure_file / 'Usecase2_RB' / 'H2Pressure.png', dpi=150)
...
plt.savefig(figure_file / 'Usecase2_RB' / 'external power.png', dpi=150)
...
plt.savefig(figure_file / 'Usecase2_RB' / 'electrolyser.png')
...
plt.savefig(figure_file / 'Usecase2_RB' / 'percentage.png')
...
plt.savefig(figure_file / 'Usecase2_RB' / 'economics.png')
...
try:
    pd_results.to_csv(figure_file / 'Usecase2_RB' / 'results_usecase2.csv')
