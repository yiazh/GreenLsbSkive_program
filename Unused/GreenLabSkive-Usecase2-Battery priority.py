...
predicted_day_ahead_ele_price = ele_price_prediction.Ele_price_prediction()
...
ax_pre_solar.grid()
plt.savefig(figure_file /'Usecase2-bpm' / 'solar_pred.png', dpi=150)
plt.show()
...
ax_pre_wind.grid()
plt.savefig(figure_file /'Usecase2-bpm' / 'wind_speed_pred.png', dpi=150)
plt.show()
...
while cycle < total_cycle:
    ...
    if Ex_power > 0:
        ...
        if Battery_storage == 0 or Ex_power - Battery_storage > 0:
            if Ex_power - Battery_storage >= Electrolyser_gls.max_power:
...
plt.savefig(figure_file /'Usecase2-bpm' / 'res.png', dpi=150)
plt.show()
...
plt.savefig(figure_file /'Usecase2-bpm' / 'battery_soc.png', dpi=150)
plt.show()
...
plt.savefig(figure_file /'Usecase2-bpm' / 'H2Pressure.png', dpi=150)
plt.show()
...
plt.savefig(figure_file /'Usecase2-bpm' / 'external power.png', dpi=150)
plt.show()
...
plt.savefig(figure_file /'Usecase2-bpm' / 'electrolyser.png')
plt.show()
...
plt.savefig(figure_file /'Usecase2-bpm' / 'economics.png')
plt.show()
...
try:
    pd_results.to_csv(figure_file /'Usecase2-bpm' /'results_usecase2-bpm.csv')
